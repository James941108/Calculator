...
public class PlusTest {
    ...
    public void plus(){
        //Action
        onView(withId(R.id.edt_firstNumber)).perform(typeText(String.valueOf(firstNumber)));
        onView(withId(R.id.edt_secondNumber)).perform(typeText(String.valueOf(secondNumber)));
