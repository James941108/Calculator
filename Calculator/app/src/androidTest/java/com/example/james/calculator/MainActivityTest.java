...
public class MainActivityTest {
    ...
    @Test
    public void divide_2_0_should_be_error_message(){
        //Action
        onView(withId(R.id.edt_firstNumber)).perform(typeText("2"));
        onView(withId(R.id.edt_secondNumber)).perform(typeText("0"));
        onView(withId(R.id.btn_divide)).perform(click());

        //Assert
        onView(withId(R.id.tv_result)).check(matches(withText("หาร 0 ไม่ได้นะ")));
    }
}